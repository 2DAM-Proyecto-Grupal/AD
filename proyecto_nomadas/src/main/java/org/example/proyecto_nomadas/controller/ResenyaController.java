...
public class ResenyaController {
    ...
    public ResponseEntity<List<ResenyaResponseDto>> findByCiudad(@RequestBody CiudadRequestDto ciudad){
    ...
    public ResponseEntity<List<ResenyaResponseDto>> findByUsuario(@RequestBody UsuarioRequestDto usuario){
    ...
    public Resenya addResenya(@RequestBody ResenyaRequestDto resenya){
        return service.addResenya(resenya);
    }

    @PutMapping("/modResenya")
    public Resenya modificarResenya(@RequestBody ResenyaRequestDto resenya){
        return service.modificarResenya(resenya);
    }

    @DeleteMapping("/deleteResenya/{resenya}")

    public void deleteResenya(@RequestBody ResenyaRequestDto resenya){
